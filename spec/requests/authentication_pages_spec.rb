...
describe "Authentication" do
	...
	describe "signin" do
		...
		describe "with valid information" do
			...
			it { should have_link('Browse',    href: courses_path) }
			it { should have_link('Browse',    href: users_path) }
	...
	describe "authorization" do
		...
		describe "for non-signed-in users" do
			...
			describe "in the Users controller" do
				...
				describe "visiting the courses following page" do
					before { visit following_user_path(user) }
					it { should have_selector('title', text: 'Sign in') }
				end

				describe "visiting the user followers page" do
					let(:course) { FactoryGirl.create(:course) }
					before { visit followers_course_path(course) }
					it { should have_selector('title', text: 'Sign in') }
				end
			end
